      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/UUUPC",
                   'caption'=>'تمت البرمجه بواسطه (@UUUPC) 💻',
...
لمراسه المطور - @UUUPC",
                  'reply_markup'=>json_encode([
					...
					$bot->sendphoto([
							'chat_id'=>$chatId,
							'photo'=> "https://t.me/ZIEEM1/1274",
							 'caption'=>'البوت مدفوع 💲 و ليس مجاني 👁‍🗨
لشراء نسخه مراسلةة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| مطور البوت','url'=>'t.me/UUUPC']],
                       [['text'=>"▪️| قناه صيد المشتركين", 'url'=>"t.me/UUUPC"]],
                      ]
                  ])
              ]);   
				}
